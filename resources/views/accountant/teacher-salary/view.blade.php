        ...
        <div class="card-body">
            ...
            <div class="col-12">
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex">
                            <form class="col-5 d-flex gap-3 mb-5" action="{{ route('accountant.teacher.salary.view.teachers') }}">
                                <div class="col-7">
                                ...
                                <tbody>
                                    ...
                                    <tr class="">
                                        ...
                                        <td style="vertical-align: middle">
                                            ...
                                            @else
                                            <a class="btn btn-warning" href="{{route('accountant.teacher.salary.generate',['id'=>$teacher->id, 'date' => $date])}}">Generate</a>
                                            @endif
                                        </td>
                                        <td style="vertical-align: middle">
                                            @if($salary != null)
                                            ...
                                            @else
                                            <a class="btn btn-danger" href="{{route('accountant.teacher.salary.status',$salary->id)}}">Pay Now</a>
                                            @endif
                                            @else
                                            --
                                            @endif
                                        ...
                                        <td style="vertical-align: middle">
                                            @if($salary != null)
                                            <a class="btn btn-secondary" href="{{route('accountant.teacher.salary.payslip',$salary->id)}}">View Payslip</a>
                                            @else
                                            --
                                            @endif
                                        </td>
