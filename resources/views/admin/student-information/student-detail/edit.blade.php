            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body p-4">
                        <div class="row g-3">
                            <div class="form-body">
                                <form class="row g-3" method="POST" action="{{ route('admin.student.details.update',$detail->id) }}" enctype="multipart/form-data">
                                    @csrf
                                    <div class="col-3">
                                    ...
                                    <div class="col-12 d-flex gap-3 justify-content-end">
                                        <a href="{{route('admin.student.details')}}" class="col-2 btn btn-outline-danger">Cancel</a>
