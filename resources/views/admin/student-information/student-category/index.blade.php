                ...
                <div class="col-lg-5">
                    <div class="card">
                        <div class="card-body p-4">
                            <div class="row g-3">
                                <div class="form-body">
                                    <form class="row g-3" method="POST" action="{{ route('admin.student.category.store') }}">
                                        @csrf
                                        <div class="col-12">
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="text-center">
                                            ...
                                            <td style="vertical-align: middle">
                                                ...
                                                <a href="{{route('admin.student.category.destroy',$category->id)}}" class="btn btn-outline-danger px-4"><i class="fa-solid fa-trash"></i></a>
                                            </td>
                                        </tr>
                                        @endforeach
                                    </tbody>
    ...
    <div class="modal-dialog ">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="row g-3" method="POST" action="{{ route('admin.student.category.update',$Editcategory->id) }}">
                    @csrf
                    <div class="col-12">
                        <label for="category" class="form-label">Category Name</label>
                    ...
                    <div class="col-12 d-flex gap-3 justify-content-center">
                        ...
                        <a href="{{route('admin.student.category')}}" class="col-6 btn btn-outline-danger">Cancel</a>
                    </div>
                </form>
            </div>
        </div>
