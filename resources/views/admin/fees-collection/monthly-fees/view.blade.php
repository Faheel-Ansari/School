    ...
    <div class="page-content">
        ...
        <div class="card-body">
            ...
            <div class="row d-flex flex-column gap-4">
                ...
                @endif
                <form class="row" method="GET" action="{{route('admin.fees.collection.monthly.fees.search')}}">
                    <div class="col-5">
                ...
                <div class="row d-flex justify-content-between">
                    <div class="col-6 mt-4 d-flex flex-column gap-2">
                        <div class="border border-2 px-3 @if($monthlyFees->january_fee == 'unpaid') bg-danger-subtle border-danger-subtle @elseif($monthlyFees->january_fee == 'paid') bg-success-subtle border-success-subtle @endif">
                            <p class="mb-0 d-flex justify-content-between"><span><strong>January Fees : </strong> @if($monthlyFees->january_fee == null) N/A @elseif($monthlyFees->january_fee == 'unpaid') <a href="{{route('admin.fees.collection.monthly.fees.status',['id' => $monthlyFees->id , 'month' => 'january'])}}" class="text-danger"><strong>Un-Paid</strong></a> @else <span class="text-primary"><strong>Paid</strong></span> @endif </span> @if($monthlyFees->january_fee != null)<a href="{{route('admin.fees.collection.monthly.fees.voucher',['id' => $Moredetail->id , 'month' => 'january'])}}" class="bg-secondary text-white px-2">Fee-Voucher</a>@endif</p>
                        ...
                        <div class="border border-2 px-3 @if($monthlyFees->february_fee == 'unpaid') bg-danger-subtle border-danger-subtle @elseif($monthlyFees->february_fee == 'paid') bg-success-subtle border-success-subtle @endif">
                            <p class="mb-0 d-flex justify-content-between"><span><strong>February Fees : </strong> @if($monthlyFees->february_fee == null) N/A @elseif($monthlyFees->february_fee == 'unpaid') <a href="{{route('admin.fees.collection.monthly.fees.status',['id' => $monthlyFees->id , 'month' => 'february'])}}" class="text-danger"><strong>Un-Paid</strong></a> @else <span class="text-primary"><strong>Paid</strong></span> @endif </span> @if($monthlyFees->february_fee != null)<a href="{{route('admin.fees.collection.monthly.fees.voucher',['id' => $Moredetail->id , 'month' => 'february'])}}" class="bg-secondary text-white px-2">Fee-Voucher</a>@endif</p>
                        ...
                        <div class="border border-2 px-3 @if($monthlyFees->march_fee == 'unpaid') bg-danger-subtle border-danger-subtle @elseif($monthlyFees->march_fee == 'paid') bg-success-subtle border-success-subtle @endif">
                            <p class="mb-0 d-flex justify-content-between"><span><strong>March Fees : </strong>@if($monthlyFees->march_fee == null) N/A @elseif($monthlyFees->march_fee == 'unpaid') <a href="{{route('admin.fees.collection.monthly.fees.status',['id' => $monthlyFees->id , 'month' => 'march'])}}" class="text-danger"><strong>Un-Paid</strong></a> @else <span class="text-primary"><strong>Paid</strong></span> @endif</span> @if($monthlyFees->march_fee != null)<a href="{{route('admin.fees.collection.monthly.fees.voucher',['id' => $Moredetail->id , 'month' => 'march'])}}" class="bg-secondary text-white px-2">Fee-Voucher</a>@endif </p>
                        ...
                        <div class="border border-2 px-3 @if($monthlyFees->april_fee == 'unpaid') bg-danger-subtle border-danger-subtle @elseif($monthlyFees->april_fee == 'paid') bg-success-subtle border-success-subtle @endif">
                            <p class="mb-0 d-flex justify-content-between"><span><strong>April Fees : </strong> @if($monthlyFees->april_fee == null) N/A @elseif($monthlyFees->april_fee == 'unpaid') <a href="{{route('admin.fees.collection.monthly.fees.status',['id' => $monthlyFees->id , 'month' => 'april'])}}" class="text-danger"><strong>Un-Paid</strong></a> @else <span class="text-primary"><strong>Paid</strong></span> @endif </span> @if($monthlyFees->april_fee != null)<a href="{{route('admin.fees.collection.monthly.fees.voucher',['id' => $Moredetail->id , 'month' => 'april'])}}" class="bg-secondary text-white px-2">Fee-Voucher</a>@endif</p>
                        ...
                        <div class="border border-2 px-3 @if($monthlyFees->may_fee == 'unpaid') bg-danger-subtle border-danger-subtle @elseif($monthlyFees->may_fee == 'paid') bg-success-subtle border-success-subtle @endif">
                            <p class="mb-0 d-flex justify-content-between"><span><strong>May Fees : </strong> @if($monthlyFees->may_fee == null) N/A @elseif($monthlyFees->may_fee == 'unpaid') <a href="{{route('admin.fees.collection.monthly.fees.status',['id' => $monthlyFees->id , 'month' => 'may'])}}" class="text-danger"><strong>Un-Paid</strong></a> @else <span class="text-primary"><strong>Paid</strong></span> @endif </span> @if($monthlyFees->may_fee != null)<a href="{{route('admin.fees.collection.monthly.fees.voucher',['id' => $Moredetail->id , 'month' => 'may'])}}" class="bg-secondary text-white px-2">Fee-Voucher</a>@endif</p>
                        ...
                        <div class="border border-2 px-3 @if($monthlyFees->june_fee == 'unpaid') bg-danger-subtle border-danger-subtle @elseif($monthlyFees->june_fee == 'paid') bg-success-subtle border-success-subtle @endif">
                            <p class="mb-0 d-flex justify-content-between"><span><strong>June Fees : </strong> @if($monthlyFees->june_fee == null) N/A @elseif($monthlyFees->june_fee == 'unpaid') <a href="{{route('admin.fees.collection.monthly.fees.status',['id' => $monthlyFees->id , 'month' => 'june'])}}" class="text-danger"><strong>Un-Paid</strong></a> @else <span class="text-primary"><strong>Paid</strong></span> @endif </span> @if($monthlyFees->june_fee != null)<a href="{{route('admin.fees.collection.monthly.fees.voucher',['id' => $Moredetail->id , 'month' => 'june'])}}" class="bg-secondary text-white px-2">Fee-Voucher</a>@endif</p>
                    ...
                    <div class="col-6 mt-4 d-flex flex-column gap-2">
                        <div class="border border-2 px-3 @if($monthlyFees->july_fee == 'unpaid') bg-danger-subtle border-danger-subtle @elseif($monthlyFees->july_fee == 'paid') bg-success-subtle border-success-subtle @endif">
                            <p class="mb-0 d-flex justify-content-between"><span><strong>July Fees : </strong> @if($monthlyFees->july_fee == null) N/A @elseif($monthlyFees->july_fee == 'unpaid') <a href="{{route('admin.fees.collection.monthly.fees.status',['id' => $monthlyFees->id , 'month' => 'july'])}}" class="text-danger"><strong>Un-Paid</strong></a> @else <span class="text-primary"><strong>Paid</strong></span> @endif </span> @if($monthlyFees->july_fee != null)<a href="{{route('admin.fees.collection.monthly.fees.voucher',['id' => $Moredetail->id , 'month' => 'july'])}}" class="bg-secondary text-white px-2">Fee-Voucher</a>@endif</p>
                        ...
                        <div class="border border-2 px-3 @if($monthlyFees->august_fee == 'unpaid') bg-danger-subtle border-danger-subtle @elseif($monthlyFees->august_fee == 'paid') bg-success-subtle border-success-subtle @endif">
                            <p class="mb-0 d-flex justify-content-between"><span><strong>August Fees : </strong> @if($monthlyFees->august_fee == null) N/A @elseif($monthlyFees->august_fee == 'unpaid') <a href="{{route('admin.fees.collection.monthly.fees.status',['id' => $monthlyFees->id , 'month' => 'august'])}}" class="text-danger"><strong>Un-Paid</strong></a> @else <span class="text-primary"><strong>Paid</strong></span> @endif </span> @if($monthlyFees->august_fee != null)<a href="{{route('admin.fees.collection.monthly.fees.voucher',['id' => $Moredetail->id , 'month' => 'august'])}}" class="bg-secondary text-white px-2">Fee-Voucher</a>@endif</p>
                        ...
                        <div class="border border-2 px-3 @if($monthlyFees->september_fee == 'unpaid') bg-danger-subtle border-danger-subtle @elseif($monthlyFees->september_fee == 'paid') bg-success-subtle border-success-subtle @endif">
                            <p class="mb-0 d-flex justify-content-between"><span><strong>September Fees : </strong> @if($monthlyFees->september_fee == null) N/A @elseif($monthlyFees->september_fee == 'unpaid') <a href="{{route('admin.fees.collection.monthly.fees.status',['id' => $monthlyFees->id , 'month' => 'september'])}}" class="text-danger"><strong>Un-Paid</strong></a> @else <span class="text-primary"><strong>Paid</strong></span> @endif </span> @if($monthlyFees->september_fee != null)<a href="{{route('admin.fees.collection.monthly.fees.voucher',['id' => $Moredetail->id , 'month' => 'september'])}}" class="bg-secondary text-white px-2">Fee-Voucher</a>@endif</p>
                        ...
                        <div class="border border-2 px-3 @if($monthlyFees->november_fee == 'unpaid') bg-danger-subtle border-danger-subtle @elseif($monthlyFees->november_fee == 'paid') bg-success-subtle border-success-subtle @endif">
                            <p class="mb-0 d-flex justify-content-between"><span><strong>November Fees : </strong> @if($monthlyFees->november_fee == null) N/A @elseif($monthlyFees->november_fee == 'unpaid') <a href="{{route('admin.fees.collection.monthly.fees.status',['id' => $monthlyFees->id , 'month' => 'november'])}}" class="text-danger"><strong>Un-Paid</strong></a> @else <span class="text-primary"><strong>Paid</strong></span> @endif </span> @if($monthlyFees->november_fee != null)<a href="{{route('admin.fees.collection.monthly.fees.voucher',['id' => $Moredetail->id , 'month' => 'november'])}}" class="bg-secondary text-white px-2">Fee-Voucher</a>@endif</p>
...
<div class="modal fade" id="{{'monthlyFeeVoucher-'.$Moredetail->id}}" tabindex="-1" aria-labelledby="monthlyFeeVoucherLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="{{route('admin.fees.collection.monthly.fees.voucher.month',$Moredetail->id)}}" method="GET">
                <div class="modal-body">
                    <div class="row">
                        <div class="col-12">
