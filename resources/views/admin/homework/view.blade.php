    ...
    <div class="page-content">
        ...
        <div class="card-body">
            ...
            <div class="row d-flex flex-column gap-4">
                ...
                <form class="row" method="GET" action="{{route('admin.home.work')}}">
                    <div class="col-3">
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="text-center">
                                            ...
                                            <td style="vertical-align: middle">
                                                ...
                                                <a href="{{route('admin.home.work.student.file',$homework->id)}}" class="btn btn-outline-success"><i class="fa-solid fa-download fs-3"></i></a>
                                                @else
                                                --
                                                @endif
                                            </td>
                                            ...
                                            <td style="vertical-align: middle">
                                                <a href="{{route('admin.home.work.teacher.file',$homework->id)}}" class="btn btn-outline-success"><i class="fa-solid fa-download fs-3"></i></a>
                                            </td>
                                            <td style="vertical-align: middle">
                                                ...
                                                <a href="{{route('admin.home.work.destroy',$homework->id)}}" class="btn btn-outline-danger"><i class="fa-solid fa-trash"></i></a>
                                            </td>
                                        </tr>
                                        @endforeach
                                    </tbody>
...
<div class="modal fade" id="{{'editHomework-'.$homework->id}}" tabindex="-1" aria-labelledby="editHomeworkLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            ...
            <form action="{{route('admin.home.work.update',$homework->id)}}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="modal-body">
                    <div class="row">
                        <div class="col-4">
                            ...
                            <select class="form-control @error('editClass') is-invalid @enderror" name="editClass" id="editClass{{$homework->id}}">
                                <option selected disabled>-- Select Class --</option>
                                @foreach($classes as $class)
                                <option value="{{$class->class}}" @if(old('editClass',$homework->class)==$class->class) selected @endif>
                                    @if($class->class == 'Montessori' || $class->class == 'Nursery' || $class->class == 'Pre-Primary 1' || $class->class == 'Pre-Primary 2')
                                    {{$class->class}}
                                    @else
                                    Class {{$class->class}}
...
<script>
    ...
    let editSubject{{$homework->id}} = document.querySelector('#editSubject{{$homework->id}}');
    ...
    allClasses.forEach(element => {
        if (editClasses{{$homework->id}}.value == element.class) {
            JSON.parse(element.sec_id).forEach(function(sec) {
                ...
                option.value = sec;
                option.textContent = sec;
                if (sec == selectedEditSection{{$homework->id}}) {
...
<div class="modal fade" id="addHomework" tabindex="-1" aria-labelledby="addHomeworkLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            ...
            <form action="{{route('admin.home.work.store')}}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="modal-body">
                    <div class="row">
                        <div class="col-4">
