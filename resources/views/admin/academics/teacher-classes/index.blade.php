                ...
                <div class="col-lg-4">
                    <div class="card">
                        <div class="card-body p-4">
                            <div class="row g-3">
                                <div class="form-body">
                                    <form class="row g-3" method="POST" action="{{ route('admin.teacher.class.store') }}">
                                        @csrf
                                        <div class="col-6">
                                        ...
                                        <div class="col-12">
                                            ...
                                            <div class="d-flex align-items-center gap-2">
                                                <input type="checkbox" class="mb-0 form-check @error('teacher[]') is-invalid @enderror" {{ $isChecked ? 'checked' : '' }} name="teacher[]" id="teacher{{$teacherID}}" value="{{ $teacher->name }}">
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="text-center">
                                            ...
                                            <td style="vertical-align: middle">
                                                ...
                                                <a href="{{route('admin.teacher.class.destroy',$classTeacher->id)}}" class="btn btn-outline-danger px-4"><i class="fa-solid fa-trash"></i></a>
                                            </td>
                                        </tr>
                                        @endforeach
                                    </tbody>
    ...
    <div class="modal-dialog ">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="row g-3" method="POST" action="{{ route('admin.teacher.class.update',$Editclass->id) }}">
                    @csrf
                    <div class="col-6">
                        <label for="class" class="form-label">Class</label>
                    ...
                    <div class="col-12">
                        ...
                        @endphp
                        <div class="d-flex align-items-center gap-2">
                            <input type="checkbox" class="mb-0 form-check @error('teacher[]') is-invalid @enderror" {{ $isChecked ? 'checked' : '' }} name="teacher[]" id="Editteacher{{$teacherID}}" value="{{ $teacher->name }}">
                    ...
                    <div class="col-12 d-flex gap-3 justify-content-center">
                        ...
                        <a href="{{route('admin.teacher.class')}}" class="col-5 btn btn-outline-danger">Cancel</a>
                    </div>
                </form>
            </div>
        </div>
