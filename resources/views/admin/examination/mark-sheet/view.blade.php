    ...
    <div class="page-content">
        ...
        <div class="card-body">
            ...
            <div class="row d-flex flex-column gap-4">
                <form class="row" method="GET" action="{{route('admin.examination.mark.sheet.get.student')}}">
                    <div class="col-3">
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="text-center">
                                            ...
                                            <td style="vertical-align: middle">
                                                <a href="{{route('admin.examination.mark.sheet.view',['class'=>$detail->class,'section'=>$detail->section,'exam_type'=>$selectedType,'date'=>$selectedDate,'admission_no'=>$detail->admission_no])}}" class="btn btn-primary px-4">View Mark Sheet</a>
                                            </td>
                                        </tr>
                                        @endforeach
                                    </tbody>
