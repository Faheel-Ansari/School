                            ...
                            <table id="viewDataTable" class="table mb-0">
                                ...
                                <tbody>
                                    ...
                                    <tr class="text-center">
                                        ...
                                        <td style="vertical-align: middle">
                                            <a href="{{route('admin.examination.exam.schedule.destroy',$ids)}}" class="btn btn-danger "><i class="fa-solid fa-trash"></i>Delete this Schedule</a>
                                        </td>
                                    </tr>
                                    @endif
                                    @endforeach
                    ...
                    <table id="viewDataTable" class="table mb-0">
                        ...
                        <tbody>
                            ...
                            <tr class="text-center">
                                ...
                                <td style="vertical-align: middle">
                                    <a href="{{route('admin.examination.exam.schedule.edit',$schedule->id)}}" class="btn btn-outline-primary"><i class="fa-solid fa-pen-to-square"></i></a>
                                    <a href="{{route('admin.examination.exam.schedule.destroy',$schedule->id)}}" class="btn btn-outline-danger"><i class="fa-solid fa-trash"></i></a>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
