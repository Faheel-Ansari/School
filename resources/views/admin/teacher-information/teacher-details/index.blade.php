                            ...
                            <table id="viewDataTable" class="table mb-0">
                                ...
                                <tbody class="text-center">
                                    ...
                                    <tr>
                                        ...
                                        <td style="vertical-align: middle">
                                            @if($teacher->status == '1')
                                            <a href="{{route('admin.teacher.status',$teacher->id)}}" class="btn btn-success px-4">Suspend</a>
                                            @else
                                            <a href="{{route('admin.teacher.status',$teacher->id)}}" class="btn btn-danger px-4">Un-Suspend</a>
                                            @endif
                                        </td>
                                        <td style="vertical-align: middle">
                                            <a href="{{route('admin.teacher.edit',$teacherProfile ? $teacherProfile->id : '')}}" class="btn btn-outline-primary px-4"><i class="fa-solid fa-pen-to-square"></i></a>
                                        </td>
                                    </tr>
                                    @endforeach
                                </tbody>
