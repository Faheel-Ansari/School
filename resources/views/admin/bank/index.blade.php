                            ...
                            <table id="viewDataTable" class="table mb-0">
                                ...
                                <tbody>
                                    ...
                                    <tr class="text-center">
                                        ...
                                        <td style="vertical-align: middle">
                                            @if($detail != null)
                                            <a href="{{route('admin.bank.detail.edit',$detail->id)}}" class="btn btn-primary px-4"><i class="fa-solid fa-pen-to-square"></i>Edit Details</a>
                                            @else
                                            <a href="{{route('admin.bank.detail.add.with',$bank->bank)}}" class="btn btn-success px-4"><i class="fa-solid fa-square-plus"></i>Add Details</a>
                                            @endif
                                            <a href="{{route('admin.bank.edit',$bank->id)}}" class="btn btn-outline-primary px-4"><i class="fa-solid fa-pen-to-square"></i>Edit</a>
                                            <a href="{{route('admin.bank.destroy',$bank->id)}}" class="btn btn-outline-danger px-4"><i class="fa-solid fa-trash"></i>Delete</a>
                                        </td>
                                    </tr>
                                    @endforeach
                                </tbody>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                @if($detail)
                <a href="{{route('admin.bank.detail.edit',$detail->id)}}" class="btn btn-primary px-4"><i class="fa-solid fa-pen-to-square"></i>Edit</a>
                <a href="{{route('admin.bank.detail.destroy',$detail->id)}}" class="btn btn-danger px-4"><i class="fa-solid fa-trash"></i>Delete</a>
                @endif
            </div>
        </div>
    </div>
