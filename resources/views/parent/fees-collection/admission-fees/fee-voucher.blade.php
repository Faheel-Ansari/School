            ...
            <div class="p-3 mt-4 border border-3 pb-5">
                ...
                <div class="mx-3 mt-3 mb-5">
                    ...
                    <div class="d-flex justify-content-end my-1">
                        Fee Month : {{ \Carbon\Carbon::parse($studentDetail->admission_date)->format('F-Y') }}
                    </div>
                    <div class="d-flex justify-content-between border px-2">
                        <div class="">
                            <p class="m-0">Issue Date</p>
                            <p class="m-0">{{$studentDetail->admission_date}}</p>
                        </div>
                        <div class="">
                            <p class="m-0">Due Date</p>
                            <p class="m-0">{{\Carbon\Carbon::parse($admissionFees->due_date)->format('d-M-Y')}}</p>
                        </div>
                        <div>
                    ...
                    <div class="mt-3 pb-5">
                        ...
                        <div class="d-flex justify-content-between">
                            <p class="m-0">Annual Fee</p>
                            <p class="m-0">{{$admissionFees->annual_fees}}</p>
                        </div>
                        <div class="d-flex justify-content-between">
                            <p class="m-0">Admission Fee</p>
                            <p class="m-0">{{$admissionFees->admission_fees}}</p>
                        </div>
                        <div class="d-flex justify-content-between">
                            <p class="m-0">Security Deposit</p>
                            <p class="m-0">{{$admissionFees->security_fees}}</p>
                        </div>
                        <div class="d-flex justify-content-between mt-2">
                            <p class="m-0"><strong>Total Amount before due date</strong></p>
                            <p class="m-0"><strong>{{$admissionFees->security_fees + $admissionFees->admission_fees + $admissionFees->annual_fees}}</strong></p>
                        </div>
                        <div class="d-flex justify-content-between">
                            <p class="m-0"><strong>Late fee charges</strong></p>
                            <p class="m-0"><strong>{{$admissionFees->fine_amount ? $admissionFees->fine_amount : '0'}}</strong></p>
                        </div>
                        <div class="d-flex justify-content-between">
                            <p class="m-0"><strong>Total Amount before due date</strong></p>
                            <p class="m-0"><strong>{{$admissionFees->fine_amount ? $admissionFees->security_fees + $admissionFees->admission_fees + $admissionFees->annual_fees + $admissionFees->fine_amount : $admissionFees->security_fees + $admissionFees->admission_fees + $admissionFees->annual_fees}}</strong></p>
                        </div>
                    </div>
                </div>
            </div>
