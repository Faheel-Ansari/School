                                ...
                                <table id="viewDataTable" class="table mb-0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="text-center">
                                            <td style="vertical-align: middle" class="text-wrap">{{Carbon::parse($notice->updated_at)->format('d M Y')}}</td>
                                            <td style="vertical-align: middle" class="text-wrap">{{$notice->title}}</td>
                                            <td style="vertical-align: middle">
                                                <a data-bs-toggle="modal" data-bs-target="{{'#noticeDescp-'.$notice->id}}" class="btn btn-outline-primary px-4">View Description</a>
                                            </td>
                                        </tr>
                                        @endforeach
                                    </tbody>
