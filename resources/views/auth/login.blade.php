                            ...
                            <div class="card-body p-sm-5">
                                <div class="">
                                    ...
                                    <div class="form-body">
                                        ...
                                        @elseif(session('status') == 'adminSuspend')
                                        <div class="text-center mb-4 text-danger">
                                            <p>Your account has been <strong>suspended</strong>.</p>
                                        </div>
                                        @endif
                                        <form class="row g-3" name="" id="" method="POST" action="{{ route('login') }}">
                                            @csrf

                                            <div class="col-12">
                                                <label for="email" class="form-label">Email</label>
                                                <input type="email" class="form-control @error('email') is-invalid @enderror" name="email" id="email" value="{{old('email')}}" placeholder="example@gmail.com">
                                                @error('email')
