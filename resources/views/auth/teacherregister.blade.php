                                    ...
                                    <div class="form-body">
                                        <form class="row g-3" name="" id="" method="POST" action="{{ route('teacherregister') }}">
                                            ...
                                            <div class="col-12">
                                                ...
                                                <input type="text" value="{{old('name')}}" class="form-control @error('name') is-invalid @enderror" name="name" id="name" placeholder="Enter Full name">
                                            </div>
                                            <div class="col-12">
