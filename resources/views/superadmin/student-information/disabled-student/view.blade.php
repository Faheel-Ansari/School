                                    ...
                                    <tbody>
                                        ...
                                        <tr class="text-center">
                                            ...
                                            <td style="vertical-align: middle">
                                                ...
                                                <a href="{{route('superadmin.student.disabled.remove',$detail->id)}}" class="btn btn-danger px-4">Remove from Disabled</a>
                                                @else
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="row" method="POST" action="{{route('superadmin.student.disabled.store',$Moredetail->id)}}">
                    @csrf
                    <div class="col-12">
