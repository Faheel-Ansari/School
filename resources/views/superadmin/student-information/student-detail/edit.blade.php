            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body p-4">
                        <div class="row g-3">
                            <div class="form-body">
                                <form class="row g-3" method="POST" action="{{ route('superadmin.student.details.update',$detail->id) }}" enctype="multipart/form-data">
                                    @csrf
                                    <div class="col-3">
                                        <label for="admission_no" class="form-label">Admission No</label>
                                        <input type="text" value="{{old('admission_no',$detail->admission_no)}}" class="form-control @error('admission_no') is-invalid @enderror" name="admission_no" id="admission_no">
                                        @error('admission_no') <span class="text-danger">{{ $message }}</span> @enderror
                                    </div>
                                    <div class="col-3">
                                        <label for="roll_no" class="form-label">Roll No</label>
                                        <input type="text" value="{{old('roll_no',$detail->roll_no)}}" class="form-control @error('roll_no') is-invalid @enderror" name="roll_no" id="roll_no">
                                    ...
                                    <div class="col-3">
                                        ...
                                        <input type="text" value="{{old('name',$detail->full_name)}}" class="form-control @error('name') is-invalid @enderror" name="name" id="name">
                                        @error('name') <span class="text-danger">{{ $message }}</span> @enderror
                                    </div>
                                    <div class="col-3">
                                        <label for="dob" class="form-label">Date of Birth</label>
                                        <input type="date" value="{{old('dob',$detail->dob)}}" class="form-control @error('dob') is-invalid @enderror" name="dob" id="dob">
                                    ...
                                    <div class="col-3">
                                        ...
                                        <input type="text" value="{{$detail->admission_date}}" class="form-control @error('admission_date') is-invalid @enderror" name="admission_date" id="admission_date" readonly>
                                    ...
                                    <div class="col-2">
                                        ...
                                        <select class="form-control @error('category') is-invalid @enderror" name="category" id="category">
                                            ...
                                            <option value="{{$category->category}}" {{old('category',$detail->category) == $category->category ? 'selected' : ''}}>{{$category->category}}</option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="col-2">
                                        ...
                                        <input type="text" value="{{old('religion',$detail->religion)}}" class="form-control @error('religion') is-invalid @enderror" name="religion" id="religion">
                                        @error('religion') <span class="text-danger">{{ $message }}</span> @enderror
                                    </div>
                                    <div class="col-2">
                                        <label for="caste" class="form-label">Caste</label>
                                        <input type="text" value="{{old('caste',$detail->caste)}}" class="form-control @error('caste') is-invalid @enderror" name="caste" id="caste">
                                    ...
                                    <div class="col-3">
                                        ...
                                        <select class="form-control @error('blood_group') is-invalid @enderror" name="blood_group" id="blood_group">
                                            ...
                                            <option value="O+" {{old('blood_group',$detail->blood_group) == 'O+' ? 'selected' : ''}}>O+</option>
                                            <option value="A+" {{old('blood_group',$detail->blood_group) == 'A+' ? 'selected' : ''}}>A+</option>
                                            <option value="B+" {{old('blood_group',$detail->blood_group) == 'B+' ? 'selected' : ''}}>B+</option>
                                            <option value="AB+" {{old('blood_group',$detail->blood_group) == 'AB+' ? 'selected' : ''}}>AB+</option>
                                            <option value="O-" {{old('blood_group',$detail->blood_group) == 'O-' ? 'selected' : ''}}>O-</option>
                                            <option value="A-" {{old('blood_group',$detail->blood_group) == 'A-' ? 'selected' : ''}}>A-</option>
                                            <option value="B-" {{old('blood_group',$detail->blood_group) == 'B-' ? 'selected' : ''}}>B-</option>
                                            <option value="AB-" {{old('blood_group',$detail->blood_group) == 'AB-' ? 'selected' : ''}}>AB-</option>
                                    ...
                                    <div class="col-2">
                                        ...
                                        <select class="form-control @error('house') is-invalid @enderror" name="house" id="house">
                                            ...
                                            <option value="{{$house->house}}" {{old('house',$detail->house) == $house->house ? 'selected' : ''}}>{{$house->house}}</option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="col-2">
                                        ...
                                        <input type="text" value="{{old('height',$detail->height)}}" class="form-control @error('height') is-invalid @enderror" name="height" id="height">
                                        @error('height') <span class="text-danger">{{ $message }}</span> @enderror
                                    </div>
                                    <div class="col-2">
                                        <label for="weight" class="form-label">Weight</label>
                                        <input type="text" value="{{old('weight',$detail->weight)}}" class="form-control @error('weight') is-invalid @enderror" name="weight" id="weight">
                                        @error('weight') <span class="text-danger">{{ $message }}</span> @enderror
                                    </div>
                                    <div class="col-3">
                                        <label for="measure_date" class="form-label">Measurement Date</label>
                                        <input type="date" value="{{old('measure_date',$detail->measure_date)}}" class="form-control @error('measure_date') is-invalid @enderror" name="measure_date" id="measure_date">
                                        @error('measure_date') <span class="text-danger">{{ $message }}</span> @enderror
                                    </div>
                                    <div class="col-12">
                                        <label for="medical_history" class="form-label">Medical History</label>
                                        <textarea class="form-control @error('medical_history') is-invalid @enderror" name="medical_history" id="medical_history">{{old('medical_history',$detail->medical_history)}}</textarea>
                                    ...
                                    <div class="col-4">
                                        ...
                                        <input type="text" value="{{old('father_name',$detail->father_name)}}" class="form-control @error('father_name') is-invalid @enderror" name="father_name" id="father_name">
                                        @error('father_name') <span class="text-danger">{{ $message }}</span> @enderror
                                    </div>
                                    <div class="col-4">
                                        <label for="father_phone" class="form-label">Father Phone</label>
                                        <input type="tel" value="{{old('father_phone',$detail->father_phone)}}" class="form-control @error('father_phone') is-invalid @enderror" name="father_phone" id="father_phone">
                                    ...
                                    <div class="col-4">
                                        ...
                                        <input type="text" value="{{old('mother_name',$detail->mother_name)}}" class="form-control @error('mother_name') is-invalid @enderror" name="mother_name" id="mother_name">
                                        @error('mother_name') <span class="text-danger">{{ $message }}</span> @enderror
                                    </div>
                                    <div class="col-4">
                                        <label for="mother_phone" class="form-label">Mother Phone</label>
                                        <input type="tel" value="{{old('mother_phone',$detail->mother_phone)}}" class="form-control @error('mother_phone') is-invalid @enderror" name="mother_phone" id="mother_phone">
                                    ...
                                    <div class="col-12 d-flex gap-4">
                                        ...
                                        <div class="d-flex gap-2 align-items-center">
                                            <input type="radio" value="Father" class="form-radio @error('father_radio') is-invalid @enderror" name="guardian_radio" id="father_radio" {{old('guardian_radio',$detail->guardian_radio) == 'Father' ? 'checked' : ''}}>
                                            <label for="father_radio" class="form-label mb-0">Father</label>
                                        </div>
                                        <div class="d-flex gap-2 align-items-center">
                                            <input type="radio" value="Mother" class="form-radio @error('mother_radio') is-invalid @enderror" name="guardian_radio" id="mother_radio" {{old('guardian_radio',$detail->guardian_radio) == 'Mother' ? 'checked' : ''}}>
                                            <label for="mother_radio" class="form-label mb-0">Mother</label>
                                        </div>
                                        <div class="d-flex gap-2 align-items-center">
                                            <input type="radio" value="Other" class="form-radio @error('other_radio') is-invalid @enderror" name="guardian_radio" id="other_radio" {{old('guardian_radio',$detail->guardian_radio) == 'Other' ? 'checked' : ''}}>
                                    ...
                                    <div class="col-3">
                                        ...
                                        <input type="tel" value="{{old('guardian_name',$detail->guardian_name)}}" class="form-control @error('guardian_name') is-invalid @enderror" name="guardian_name" id="guardian_name">
                                    ...
                                    <div class="col-3">
                                        ...
                                        <input type="text" value="{{old('guardian_relation',$detail->guardian_relation)}}" class="form-control @error('guardian_relation') is-invalid @enderror" name="guardian_relation" id="guardian_relation">
                                    ...
                                    <div class="col-3">
                                        ...
                                        <input type="email" value="{{old('guardian_email',$detail->guardian_email)}}" class="form-control @error('guardian_email') is-invalid @enderror" name="guardian_email" id="guardian_email">
                                    ...
                                    <div class="col-3">
                                        ...
                                        <input type="tel" value="{{old('guardian_phone',$detail->guardian_phone)}}" class="form-control @error('guardian_phone') is-invalid @enderror" name="guardian_phone" id="guardian_phone">
                                    ...
                                    <div class="col-9">
                                        ...
                                        <input type="text" value="{{old('guardian_address',$detail->guardian_address)}}" class="form-control @error('guardian_address') is-invalid @enderror" name="guardian_address" id="guardian_address">
                                    ...
                                    <div class="col-4">
                                        ...
                                        <input type="text" value="{{old('father_cnic',$detail->father_cnic)}}" class="form-control @error('father_cnic') is-invalid @enderror" name="father_cnic" id="father_cnic" placeholder="eg: 42101-1234567-8">
                                        @error('father_cnic')
                                    ...
                                    <div class="col-4">
                                        ...
                                        <input type="text" value="{{old('mother_cnic',$detail->mother_cnic)}}" class="form-control @error('mother_cnic') is-invalid @enderror" name="mother_cnic" id="mother_cnic" placeholder="eg: 42101-1234567-9">
                                        @error('mother_cnic')
                                        <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="col-4 d-none" id="guardianCnicDiv">
                                        ...
                                        <input type="text" value="{{old('guardian_cnic',$detail->guardian_cnic)}}" class="form-control @error('guardian_cnic') is-invalid @enderror" name="guardian_cnic" id="guardian_cnic" placeholder="eg: 42101-1234567-6">
                                        @error('guardian_cnic')<span class="text-danger">{{ $message }}</span>@enderror
                                    </div>
                                    ...
                                    <div class="col-12 d-flex gap-3 justify-content-end">
                                        <a href="{{route('superadmin.student.details')}}" class="col-2 btn btn-outline-danger">Cancel</a>
                                        <button type="submit" class="col-2 btn btn-primary">Save</button>
                                    </div>
                                </form>
                            </div>
                        </div>
