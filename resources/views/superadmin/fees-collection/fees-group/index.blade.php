                ...
                <div class="col-lg-5">
                    <div class="card">
                        <div class="card-body p-4">
                            <div class="row g-3">
                                <div class="form-body">
                                    <form class="row g-3" method="POST" action="{{ route('superadmin.fees.collection.fees.group.store') }}">
                                        @csrf
                                        <div class="col-12">
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="text-center">
                                            ...
                                            <td style="vertical-align: middle">
                                                ...
                                                <a href="{{route('superadmin.fees.collection.fees.group.destroy',$group->id)}}" class="btn btn-outline-danger px-4"><i class="fa-solid fa-trash"></i></a>
                                            </td>
                                        </tr>
                                        @endforeach
                                    </tbody>
    ...
    <div class="modal-dialog ">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="row g-3" method="POST" action="{{ route('superadmin.fees.collection.fees.group.update',$Editgroup->id) }}">
                    @csrf
                    <div class="col-12">
                        <label for="name" class="form-label">Name</label>
                        <select class="form-control @error('name') is-invalid @enderror" name="name" id="name">
                    ...
                    <div class="col-12 d-flex gap-3 justify-content-center">
                        ...
                        <a href="{{route('superadmin.fees.collection.fees.group')}}" class="col-6 btn btn-outline-danger">Cancel</a>
                    </div>
                </form>
            </div>
        </div>
