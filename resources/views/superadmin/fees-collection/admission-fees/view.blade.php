    ...
    <div class="page-content">
        ...
        <div class="card-body">
            ...
            <div class="row d-flex flex-column gap-4">
                <form class="row" method="GET" action="{{route('superadmin.fees.collection.admission.fees.search')}}">
                    <div class="col-5">
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="text-center">
                                            ...
                                            <td style="vertical-align: middle">
                                                <a href="{{route('superadmin.fees.collection.admission.fees.cash.payment',$detail->id)}}" class="btn btn-success">Cash</a>
                                                <a href="{{route('superadmin.fees.collection.admission.fees.bank.transfer.payment',$detail->id)}}" class="btn btn-warning">Bank Transfer</a>
                                            </td>
                                            <td style="vertical-align: middle">
                                                <a href="{{route('superadmin.fees.collection.admission.fees.voucher',$detail->id)}}" class="btn btn-primary px-4">View Voucher</a>
                                            </td>
                                        </tr>
                                        @endforeach
                                    </tbody>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="d-flex justify-content-end">
                    ...
                    <a href="{{route('superadmin.fees.collection.admission.fees.status',$admissionFees->id)}}" class="btn btn-danger">Pay Now</a>
                    @else
