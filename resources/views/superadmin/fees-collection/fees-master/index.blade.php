                ...
                <div class="col-lg-4">
                    <div class="card">
                        <div class="card-body p-4">
                            <div class="row g-3">
                                <div class="form-body">
                                    <form class="row g-3" method="POST" action="{{ route('superadmin.fees.collection.fees.master.store') }}">
                                        @csrf
                                        <div class="col-12">
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="text-center">
                                            ...
                                            <td style="vertical-align: middle">
                                                ...
                                                <a href="{{route('superadmin.fees.collection.fees.master.destroy',$master->id)}}" class="btn btn-outline-danger px-4"><i class="fa-solid fa-trash"></i></a>
                                            </td>
                                        </tr>
                                        @endforeach
                                    </tbody>
    ...
    <div class="modal-dialog ">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="row g-3" method="POST" action="{{ route('superadmin.fees.collection.fees.master.update',$Editmaster->id) }}">
                    @csrf
                    <div class="col-12">
                        <label for="fees_group" class="form-label">Fees Group</label>
                        <select class="form-control @error('fees_group') is-invalid @enderror" name="fees_group" id="fees_group">
                    ...
                    <div class="col-12 d-flex gap-3 justify-content-center">
                        ...
                        <a href="{{route('superadmin.fees.collection.fees.master')}}" class="col-6 btn btn-outline-danger">Cancel</a>
                    </div>
                </form>
            </div>
        </div>
