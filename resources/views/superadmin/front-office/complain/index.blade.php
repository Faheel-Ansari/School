                                ...
                                <tbody>
                                    ...
                                    <tr class="text-center">
                                        ...
                                        <td style="vertical-align: middle">
                                            ...
                                            <a href="{{route('superadmin.frontoffice.complain.destroy',$complain->id)}}" class="btn btn-outline-danger px-4"><i class="fa-solid fa-trash"></i></a>
                                        </td>
                                    </tr>
                                    @endforeach
                                </tbody>
    ...
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="row g-3" method="POST" action="{{ route('superadmin.frontoffice.complain.store') }}">
                    @csrf
                    <div class="col-4">
                    ...
                    <div class="col-12 d-flex gap-3 justify-content-center">
                        ...
                        <a href="{{route('superadmin.frontoffice.complain')}}" class="col-4 btn btn-outline-danger">Cancel</a>
                    </div>
                </form>
            </div>
        </div>
...
<div class="modal fade" id="{{'complainEdit-'.$Editcomplain->id}}" tabindex="-1" aria-labelledby="complainEditLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="row g-3" method="POST" action="{{ route('superadmin.frontoffice.complain.update',$Editcomplain->id) }}">
                    @csrf
                    <div class="col-6">
                        <label for="complaint_type" class="form-label">Complain-Type</label>
                        <select class="form-control @error('complaint_type') is-invalid @enderror" name="complaint_type" id="complaint_type">
