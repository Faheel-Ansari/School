                                ...
                                <tbody>
                                    ...
                                    <tr class="text-center">
                                        ...
                                        <td style="vertical-align: middle">
                                            ...
                                            <a href="{{route('superadmin.frontoffice.visitor.book.destroy',$visitor->id)}}" class="btn btn-outline-danger px-4"><i class="fa-solid fa-trash"></i></a>
                                        </td>
                                    </tr>
                                    @endforeach
                                </tbody>
    ...
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="row g-3" method="POST" action="{{ route('superadmin.frontoffice.visitor.book.store') }}">
                    @csrf
                    <div class="col-6">
                    ...
                    <div class="col-12 d-flex gap-3 justify-content-center">
                        ...
                        <a href="{{route('superadmin.frontoffice.visitor.book')}}" class="col-4 btn btn-outline-danger">Cancel</a>
                    </div>
                </form>
            </div>
        </div>
...
<div class="modal fade" id="{{'visitorEdit-'.$Editvisitor->id}}" tabindex="-1" aria-labelledby="visitorEditLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="row g-3" method="POST" action="{{ route('superadmin.frontoffice.visitor.book.update',$visitor->id) }}">
                    @csrf
                    <div class="col-6">
                        <label for="purpose" class="form-label">Purpose</label>
                        <select class="form-control @error('purpose') is-invalid @enderror" name="purpose" id="purpose">
