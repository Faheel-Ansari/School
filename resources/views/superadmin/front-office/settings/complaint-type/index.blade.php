                                ...
                                <tbody>
                                    ...
                                    <tr class="text-center">
                                        ...
                                        <td style="vertical-align: middle">
                                            ...
                                            <a href="{{route('superadmin.frontoffice.setting.complaint.destroy',$complaint->id)}}" class="btn btn-outline-danger px-4"><i class="fa-solid fa-trash"></i></a>
                                        </td>
                                    </tr>
                                    @endforeach
                                </tbody>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="row g-3" method="POST" action="{{ route('superadmin.frontoffice.setting.complaint.store') }}">
                    @csrf
                    <div class="col-12">
                    ...
                    <div class="col-12 d-flex gap-3 justify-content-center">
                        ...
                        <a href="{{route('superadmin.frontoffice.setting.complaint')}}" class="col-4 btn btn-outline-danger">Cancel</a>
                    </div>
                </form>
            </div>
        </div>
...
<div class="modal fade" id="{{'complaintEdit-'.$Editcomplaint->id}}" tabindex="-1" aria-labelledby="complaintEditLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="row g-3" method="POST" action="{{ route('superadmin.frontoffice.setting.complaint.update',$Editcomplaint->id) }}">
                    @csrf
                    <div class="col-12">
                        <label for="complaint_type" class="form-label">Complaint Type</label>
