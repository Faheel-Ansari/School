                            ...
                            <table id="viewDataTable" class="table mb-0">
                                ...
                                <tbody>
                                    ...
                                    <tr class="text-center">
                                        ...
                                        <td style="vertical-align: middle">
                                            <a href="{{route('superadmin.board.edit',$board->id)}}" class="btn btn-outline-primary px-4"><i class="fa-solid fa-pen-to-square"></i>Edit</a>
                                            <a href="{{route('superadmin.board.destroy',$board->id)}}" class="btn btn-outline-danger px-4"><i class="fa-solid fa-trash"></i>Delete</a>
                                        </td>
                                    </tr>
                                    @endforeach
                                </tbody>
