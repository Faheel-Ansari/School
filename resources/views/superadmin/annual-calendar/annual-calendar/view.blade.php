                                    ...
                                    <tbody>
                                        ...
                                        <tr class="text-center">
                                            ...
                                            <td style="vertical-align: middle">
                                                ...
                                                <a href="{{route('superadmin.annual.calendar.destroy',$calendar->id)}}" class="btn btn-outline-danger px-4"><i class="fa-solid fa-trash"></i></a>
                                            </td>
                                        </tr>
                                        @endforeach
                                    </tbody>
...
<div class="modal fade" id="{{'editAnnualCalendar-'.$calendar->id}}" tabindex="-1" aria-labelledby="editAnnualCalendarLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form action="{{route('superadmin.annual.calendar.update',$calendar->id)}}" method="POST">
                @csrf
...
<div class="modal fade" id="addAnnualCalendar" tabindex="-1" aria-labelledby="addAnnualCalendarLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form action="{{route('superadmin.annual.calendar.store')}}" method="POST">
                @csrf
                <div class="modal-body">
                    <div class="row">
                        <div class="col-12">
