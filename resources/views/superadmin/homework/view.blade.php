                                    ...
                                    <tbody>
                                        ...
                                        <tr class="text-center">
                                            ...
                                            <td style="vertical-align: middle">
                                                ...
                                                <a href="{{route('superadmin.home.work.student.file',$homework->id)}}" class="btn btn-outline-success"><i class="fa-solid fa-download fs-3"></i></a>
                                                @else
                                                --
                                                @endif
                                            </td>
                                            ...
                                            <td style="vertical-align: middle">
                                                <a href="{{route('superadmin.home.work.teacher.file',$homework->id)}}" class="btn btn-outline-success"><i class="fa-solid fa-download fs-3"></i></a>
                                            </td>
                                            <td style="vertical-align: middle">
                                                ...
                                                <a href="{{route('superadmin.home.work.destroy',$homework->id)}}" class="btn btn-outline-danger"><i class="fa-solid fa-trash"></i></a>
                                            </td>
                                        </tr>
                                        @endforeach
                                    </tbody>
...
<div class="modal fade" id="{{'editHomework-'.$homework->id}}" tabindex="-1" aria-labelledby="editHomeworkLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            ...
            <form action="{{route('superadmin.home.work.update',$homework->id)}}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="modal-body">
                    <div class="row">
                        <div class="col-4">
