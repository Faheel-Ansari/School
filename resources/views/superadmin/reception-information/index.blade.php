                ...
                <div class="col-4">
                    <div class="card">
                        <div class="card-body p-4">
                            <div class="row g-3">
                                <div class="form-body">
                                    <form class="row g-3" method="POST" action="{{ route('superadmin.receptionist.store') }}" enctype="multipart/form-data">
                                        @csrf
                                        <div class="col-12">
                                    ...
                                    <tbody class="text-center">
                                        ...
                                        <tr>
                                            ...
                                            <td style="vertical-align: middle">
                                                ...
                                                <a href="{{route('superadmin.receptionist.status',$receptionist->id)}}" class="btn btn-success px-4">Suspend</a>
                                                @else
                                                <a href="{{route('superadmin.receptionist.status',$receptionist->id)}}" class="btn btn-danger px-4">Un-Suspend</a>
                                                @endif
                                            </td>
                                            <td style="vertical-align: middle">
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="row g-3" method="POST" action="{{ route('superadmin.receptionist.update',$receptionist->id) }}">
                    @csrf
                    <div class="col-6">
                        <label for="name" class="form-label">Full Name</label>
