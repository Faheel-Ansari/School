    ...
    <div class="page-content">
        ...
        <div class="card-body">
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <form class="row g-3 mb-5" action="{{ route('superadmin.student.attendance') }}">
                            <div class="col-4">
                        ...
                        <form method="POST" class="mt-3" action="{{route('superadmin.student.attendance.store')}}">
                            @csrf
                            ...
                            <div class="mb-3 d-flex justify-content-between align-items-center">
                                <div class="d-flex align-items-center gap-4">
                                    <p class="mb-0">Set attendance for all students as </p>
