            ...
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        ...
                        <li class="breadcrumb-item"><a href="{{route('superadmin.bank')}}" class="text-decoration-none">Bank</a></li>
                ...
                <div class="border border-3 p-4 rounded">
                    <div class="card">
                        <div class="card-body p-4">
                            <div class="row g-3">
                                <div class="form-body">
                                    <form class="row g-3" method="POST" action="{{ route('superadmin.bank.detail.update',$detail->id) }}">
                                        @csrf
                                        <div class="col-12">
                                            <label for="bank" class="form-label">Bank Name</label>
                                            <select class="form-control @error('bank') is-invalid @enderror" name="bank" id="bank">
                                                <option value="{{$detail->bank}}" selected>{{$detail->bank}}</option>
                                            </select>
...
<span id="ubl_details" class="d-none">
    <div class="col-12">
        ...
        <input type="number" value="{{old('pv_no',$detail->pv_no)}}" class="form-control @error('pv_no') is-invalid @enderror" name="pv_no" id="ubl_pv_no">
        @error('pv_no') <span class="text-danger">{{$message}}</span> @enderror
    </div>
    <div class="col-12">
        <label for="buyer_code" class="form-label">Buyer Code</label>
        <input type="number" value="{{old('buyer_code',$detail->buyer_code)}}" class="form-control @error('buyer_code') is-invalid @enderror" name="buyer_code" id="ubl_buyer_code">
        @error('buyer_code') <span class="text-danger">{{$message}}</span> @enderror
    </div>
    <div class="col-12">
        <label for="bank_ac" class="form-label">Account Number</label>
        <input type="number" value="{{old('bank_ac',$detail->bank_ac)}}" class="form-control @error('bank_ac') is-invalid @enderror" name="bank_ac" id="ubl_bank_ac">
...
<span id="mcb_details" class="d-none">
    <div class="col-12">
        ...
        <input type="text" value="{{old('ac_title',$detail->ac_title)}}" class="form-control @error('ac_title') is-invalid @enderror" name="ac_title" id="mcb_ac_title">
        @error('ac_title') <span class="text-danger">{{$message}}</span> @enderror
    </div>
    <div class="col-12">
        <label for="school_region" class="form-label">School Region</label>
        <input type="text" value="{{old('school_region',$detail->school_region)}}" class="form-control @error('school_region') is-invalid @enderror" name="school_region" id="mcb_school_region">
...
<span id="alfalah_details" class="d-none">
    <div class="col-12">
        ...
        <input type="text" value="{{old('region',$detail->region)}}" class="form-control @error('region') is-invalid @enderror" name="region" id="alfalah_region">
...
<span id="askari_details" class="d-none">
    <div class="col-12">
        ...
        <input type="text" value="{{old('acms_name',$detail->acms_name)}}" class="form-control @error('acms_name') is-invalid @enderror" name="acms_name" id="askari_acms_name">
...
<span id="link_details" class="d-none">
    <div class="col-12">
        ...
        <input type="text" value="{{old('prefix',$detail->prefix)}}" class="form-control @error('prefix') is-invalid @enderror" name="prefix" id="link_prefix">
