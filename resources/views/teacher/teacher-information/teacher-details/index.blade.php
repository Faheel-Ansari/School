...
$daysInMonth = 31;
@endphp
<div class="modal fade" id="{{'detailMore-'.$teacher->id}}" tabindex="-1" aria-labelledby="detailMoreLabel" aria-hidden="true">
...
<div class="modal fade" id="{{'attendance-'.$teacher->id}}" tabindex="-1" aria-labelledby="attendanceLabel" aria-hidden="true">
