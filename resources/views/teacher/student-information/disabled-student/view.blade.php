                ...
                <form class="row" method="GET" action="{{route('teacher.student.disabled.search')}}">
                    <div class="col-5">
                        ...
                        <select class="form-control @error('class') is-invalid @enderror" name="class" id="class">
                            ...
                            <option value="{{$class}}" {{$class == $selectedClass ? 'selected' : ''}}>
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="text-center">
                                            ...
                                            <td style="vertical-align: middle">
                                                ...
                                                <a href="{{route('teacher.student.disabled.remove',$detail->id)}}" class="btn btn-danger px-4">Remove from Disabled</a>
                                                @else
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="row" method="POST" action="{{route('teacher.student.disabled.store',$Moredetail->id)}}">
                    @csrf
                    <div class="col-12">
