    ...
    <div class="page-content">
        ...
        <div class="card-body">
            ...
            <div class="mb-3 d-flex align-items-center justify-content-end">
                <a href="{{route('teacher.examination.exam.schedule.add')}}" class="btn btn-secondary"><i class="fa-solid fa-plus"></i> Add</a>
            </div>
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <form class="row g-3 mb-4" action="{{ route('teacher.examination.exam.schedule.view') }}">
                            <div class="col-3">
                            ...
                            <table id="viewDataTable" class="table mb-0">
                                ...
                                <tbody>
                                    ...
                                    <tr class="text-center">
                                        ...
                                        <td style="vertical-align: middle">
                                            <a href="{{route('teacher.examination.exam.schedule.destroy',$ids)}}" class="btn btn-danger "><i class="fa-solid fa-trash"></i>Delete this Schedule</a>
                                        </td>
                                    </tr>
                                    @endif
                                    @endforeach
                    ...
                    <table id="viewDataTable" class="table mb-0">
                        ...
                        <tbody>
                            ...
                            <tr class="text-center">
                                ...
                                <td style="vertical-align: middle">
                                    <a href="{{route('teacher.examination.exam.schedule.edit',$schedule->id)}}" class="btn btn-outline-primary"><i class="fa-solid fa-pen-to-square"></i></a>
                                    <a href="{{route('teacher.examination.exam.schedule.destroy',$schedule->id)}}" class="btn btn-outline-danger"><i class="fa-solid fa-trash"></i></a>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
