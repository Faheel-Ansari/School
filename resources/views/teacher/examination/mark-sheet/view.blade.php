                                    ...
                                    <tbody>
                                        ...
                                        <tr class="text-center">
                                            ...
                                            <td style="vertical-align: middle">
                                                <a href="{{route('teacher.examination.mark.sheet.view',['class'=>$detail->class,'section'=>$detail->section,'exam_type'=>$selectedType,'date'=>$selectedDate,'admission_no'=>$detail->admission_no])}}" class="btn btn-primary px-4">View Mark Sheet</a>
                                            </td>
                                        </tr>
                                        @endforeach
                                    </tbody>
