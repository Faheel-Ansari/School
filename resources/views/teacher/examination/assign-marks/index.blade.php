    ...
    <div class="page-content">
        ...
        <div class="card-body">
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <form class="row" method="GET" action="{{route('teacher.examination.assign.marks.create')}}">
                            <div class="col-4">
                        ...
                        @if(count($students) > 0)
                        <form method="POST" class="mt-3" action="{{route('teacher.examination.assign.marks.store')}}">
                            @csrf
