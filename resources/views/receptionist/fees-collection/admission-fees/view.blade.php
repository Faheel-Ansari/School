    ...
    <div class="page-content">
        ...
        <div class="card-body">
            ...
            <div class="row d-flex flex-column gap-4">
                <form class="row" method="GET" action="{{route('receptionist.fees.collection.admission.fees.search')}}">
                    <div class="col-5">
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="text-center">
                                            ...
                                            <td style="vertical-align: middle">
                                                <a href="{{route('receptionist.fees.collection.admission.fees.voucher',$detail->id)}}" class="btn btn-primary px-4">View Voucher</a>
                                            </td>
                                        </tr>
                                        @endforeach
                                    </tbody>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p><strong>Admission Fees : </strong> {{$admissionFees->admission_fees}}</p>
                <p><strong>Security Fees : </strong> {{$admissionFees->security_fees}}</p>
                <p><strong>Annual Fees : </strong> {{$admissionFees->annual_fees}}</p>
                <p><strong>Due Date : </strong> {{$admissionFees->due_date}}</p>
                <p><strong>Fine Amount : </strong> {{$admissionFees->fine_amount ? $admissionFees->fine_amount : 'None'}}</p>
