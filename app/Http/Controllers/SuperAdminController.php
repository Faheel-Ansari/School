...
class SuperAdminController extends Controller
{
    ...
    {
        $logo = Logo::first();
        return view('superadmin.logo.index', compact('logo'));
    }
    public function logoCreate()
    {
        return view('superadmin.logo.add');
    }
    public function logoStore(Request $request)
    {
        ...
        return redirect(route('superadmin.logo'))->with($notification);
    }
    public function logoEdit($id)
    {
        $logo = Logo::find($id);
        return view('superadmin.logo.edit', compact('logo'));
    }
    ...
    public function schoolName()
    {
        ...
        return view('superadmin.school-name.index', compact('name'));
    }
    public function schoolNameCreate()
    {
        return view('superadmin.school-name.add');
    }
    public function schoolNameStore(Request $request)
    {
        ...
        return redirect(route('superadmin.school.name'))->with($notification);
    }
    public function schoolNameEdit($id)
    {
        $name = SchoolName::find($id);
        return view('superadmin.school-name.edit', compact('name'));
    }
    ...
    public function studentDetails()
    {
        ...
        return view('superadmin.student-information.student-detail.index', compact('studentDetails'));
    }
    public function studentDetailsEdit($id)
    {
        ...
        return view('superadmin.student-information.student-detail.edit', compact('classes', 'categories', 'houses', 'allFees', 'detail', 'user', 'admissionFees'));
    }
    public function studentAdmission()
    {
        ...
        $categories = StudentCategory::get();
        $houses = StudentHouse::get();
        return view('superadmin.student-information.student-admission.add', compact('classes', 'categories', 'houses', 'allFees'));
    }
    public function studentAdmissionStore(Request $request)
    {
        ...
        return redirect(route('superadmin.student.admission'))->with($notification);
    }
    public function studentDetailsUpdate(Request $request, $id)
    {
        ...
        return redirect(route('superadmin.student.details'))->with($notification);
    }
    ...
    public function studentAttendance(Request $request)
    {
        ...
        return view('superadmin.attendance.student-attendance.view', compact('classes', 'selectedClass', 'selectedSection', 'selectedDate', 'students'));
    }
    public function studentAttendanceSearch()
    {
        $classes = AdminClasses::get();
        return view('superadmin.attendance.student-attendance.index', compact('classes'));
    }
    ...
    {
        $classes = AdminClasses::get();
        return view('superadmin.student-information.disabled-student.index', compact('classes'));
    }
    public function studentDisabledSearch(Request $request)
    {
        ...
        $selectedSection = $request->section;
        $classes = AdminClasses::get();
        return view('superadmin.student-information.disabled-student.view', compact('studentDetails', 'classes', 'selectedClass', 'selectedSection', 'reasons'));
    }
    ...
    public function homeWorkSearch()
    {
        ...
        return view('superadmin.homework.index', compact('subjectGroups', 'classes'));
    }
    public function homeWork(Request $request)
    {
        ...
        $homeworks = Homework::where('class', $request->class)
            ...
            ->get();
        return view('superadmin.homework.view', compact('subjectGroups', 'classes', 'homeworks', 'selectedGroup', 'selectedClass', 'selectedSection', 'selectedSubject'));
    }
    ...
    public function annualCalendarHoliday()
    {
        ...
        return view('superadmin.annual-calendar.holiday.index', compact('holidays'));
    }
    public function annualCalendarHolidayStore(Request $request)
    {
        ...
        return redirect(route('superadmin.annual.calendar.holiday'))->with($notification);
    }
    ...
    public function annualCalendar()
    {
        ...
        $holidays = Holiday::get();
        return view('superadmin.annual-calendar.annual-calendar.view', compact('calendars', 'holidays'));
    }
    public function annualCalendarStore(Request $request)
    {
        ...
        return redirect(route('superadmin.annual.calendar'))->with($notification);
    }
    ...
    {
        $categories = StudentCategory::get();
        return view('superadmin.student-information.student-category.index', compact('categories'));
    }
    public function studentCategoryStore(Request $request)
    {
        ...
        return redirect(route('superadmin.student.category'))->with($notification);
    }
    ...
    {
        $houses = StudentHouse::get();
        return view('superadmin.student-information.student-house.index', compact('houses'));
    }
    public function studentHouseStore(Request $request)
    {
        ...
        return redirect(route('superadmin.student.house'))->with($notification);
    }
    ...
    public function studentDisableReason()
    {
        ...
        return view('superadmin.student-information.disable-reason.index', compact('disableReasons'));
    }
    public function studentDisableReasonStore(Request $request)
    {
        ...
        return redirect(route('superadmin.student.disable.reason'))->with($notification);
    }
    ...
    {
        $classes = AdminClasses::get();
        return view('superadmin.fees-collection.admission-fees.index', compact('classes'));
    }
    public function feesCollectionAdmissionFeesVoucher($id)
    {
        ...
        return view('superadmin.fees-collection.admission-fees.fee-voucher', compact('classes', 'studentDetail', 'admissionFees', 'bankDetails', 'logo', 'schoolName'));
    }
    public function feesCollectionAdmissionFeesSearch(Request $request)
    {
        ...
        $selectedSection = $request->section;
        $classes = AdminClasses::get();
        return view('superadmin.fees-collection.admission-fees.view', compact('studentDetails', 'classes', 'selectedClass', 'selectedSection'));
    }
    ...
    {
        $classes = AdminClasses::get();
        return view('superadmin.fees-collection.monthly-fees.index', compact('classes'));
    }
    ...
    public function feesCollectionMonthlyFeesVoucher($id, $month)
    {
        ...
        $logo = Logo::first();
        $schoolName = SchoolName::first();
        return view('superadmin.fees-collection.monthly-fees.fee-voucher', compact('classes', 'studentDetail', 'monthlyFees', 'bankDetails', 'monthName', 'logo', 'schoolName'));
    }
    public function feesCollectionMonthlyFeesSearch(Request $request)
    {
        ...
        $selectedSection = $request->section;
        $classes = AdminClasses::get();
        return view('superadmin.fees-collection.monthly-fees.view', compact('studentDetails', 'classes', 'selectedClass', 'selectedSection'));
    }
    ...
    public function feesCollectionFeesGroup()
    {
        ...
        return view('superadmin.fees-collection.fees-group.index', compact('feesGroups'));
    }
    public function feesCollectionFeesGroupStore(Request $request)
    {
        ...
        return redirect(route('superadmin.fees.collection.fees.group'))->with($notification);
    }
    ...
    public function feesCollectionFeesType()
    {
        ...
        return view('superadmin.fees-collection.fees-type.index', compact('feesTypes'));
    }
    public function feesCollectionFeesTypeStore(Request $request)
    {
        ...
        return redirect(route('superadmin.fees.collection.fees.type'))->with($notification);
    }
    ...
    public function feesCollectionFeesMaster()
    {
        ...
        $feesGroups = FeesGroup::get();
        $feesTypes = FeesType::get();
        return view('superadmin.fees-collection.fees-master.index', compact('feesMasters', 'feesGroups', 'feesTypes'));
    }
    public function feesCollectionFeesMasterStore(Request $request)
    {
        ...
        return redirect(route('superadmin.fees.collection.fees.master'))->with($notification);
    }
    ...
    public function examinationExamType()
    {
        ...
        return view('superadmin.examination.exam-type.index', compact('examTypes'));
    }
    public function examinationExamTypeStore(Request $request)
    {
        ...
        return redirect(route('superadmin.examination.exam.type'))->with($notification);
    }
    ...
    public function examinationExamSchedule()
    {
        $classes = AdminClasses::get();
        $examTypes = ExamType::get();
        return view('superadmin.examination.exam-schedule.index', compact('classes','examTypes'));
    }
    public function examinationExamScheduleView(Request $request)
    {
        ...
        $examTypes = ExamType::get();
        return view('superadmin.examination.exam-schedule.view', compact('schedules', 'classes', 'sections', 'selectedClass', 'selectedSection', 'selectedType', 'selectedDate','examTypes'));
    }
    public function examinationExamScheduleCreate()
    {
        ...
        $subjectGroups = SubjectGroup::get();
        $examTypes = ExamType::get();
        return view('superadmin.examination.exam-schedule.add', compact('sections', 'classes', 'teachers', 'subjects', 'subjectGroups', 'examTypes'));
    }
    public function examinationExamScheduleStore(Request $request)
    {
        ...
        return redirect(route('superadmin.examination.exam.schedule.add'))->with($notification);
    }
    public function examinationExamScheduleEdit($id)
    {
        ...
        $subjectGroups = SubjectGroup::get();
        $examTypes = ExamType::get();
        return view('superadmin.examination.exam-schedule.edit', compact('schedule', 'classes', 'examTypes', 'sections', 'teachers', 'subjectGroups', 'subjects'));
    }
    public function examinationExamScheduleUpdate(Request $request, $id)
    {
        ...
        return redirect(route('superadmin.examination.exam.schedule'))->with($notification);
    }
    ...
    public function examinationAssignMarksCreateSearch()
    {
        ...
        $selectedType = '';
        $students = [];
        return view('superadmin.examination.assign-marks.index', compact('classes', 'subjectGroups', 'selectedDate', 'selectedGroup', 'selectedSection', 'selectedSubject', 'selectedClass', 'selectedType', 'students', 'examTypes'));
    }
    public function examinationAssignMarksCreate(Request $request)
    {
        ...
        $selectedType = $request->exam_type;
        $selectedClass = $request->class;
        return view('superadmin.examination.assign-marks.index', compact('classes', 'subjectGroups', 'selectedDate', 'selectedGroup', 'selectedSection', 'selectedSubject', 'selectedClass', 'selectedType', 'schedules', 'students', 'examTypes'));
    }
    ...
    public function examinationMarkSheetSearch()
    {
        $classes = AdminClasses::get();
        $examTypes = ExamType::get();
        return view('superadmin.examination.mark-sheet.index', compact('classes', 'examTypes'));
    }
    public function examinationMarkSheetView($class, $section, $exam_type, $date, $admission_no)
    {
        ...
        return view('superadmin.examination.mark-sheet.mark-sheet', compact('classes', 'studentDetail', 'marks', 'date', 'logo', 'schoolName','selectedType'));
    }
    public function examinationMarkSheetGetStudent(Request $request)
    {
        ...
        $classes = AdminClasses::get();
        $examTypes = ExamType::get();
        return view('superadmin.examination.mark-sheet.view', compact('studentDetails', 'classes', 'selectedClass', 'selectedDate', 'selectedType', 'selectedSection', 'marks', 'examTypes'));
    }
    ...
    public function admin()
    {
        ...
        return view('superadmin.admin-information.index', compact('admins'));
    }
    ...
    public function receptionist()
    {
        ...
        return view('superadmin.reception-information.index', compact('receptionists'));
    }
    ...
    public function accountant()
    {
        ...
        return view('superadmin.accountant-information.index', compact('accountants'));
    }
    ...
    {
        $teachers = User::where('role', 'teacher')->get();
        return view('superadmin.teacher-information.teacher-details.index', compact('teachers'));
    }
    public function teacherAdd()
    {
        return view('superadmin.teacher-information.teacher-details.add');
    }
    public function teacherStore(Request $request)
    {
        ...
        return redirect(route('superadmin.teacher'))->with($notification);
    }
    public function teacherEdit($id)
    {
        ...
        return view('superadmin.teacher-information.teacher-details.edit', compact('teacherProfile', 'teacher', 'teacherSalary'));
    }
    ...
    {
        return view('superadmin.attendance.teacher-attendance.index');
    }
    public function teacherAttendance(Request $request)
    {
        $selectedDate = $request->date;
        $teachers = User::where('role', 'teacher')->get();
        return view('superadmin.attendance.teacher-attendance.view', compact('teachers', 'selectedDate'));
    }
    ...
    public function teacherClass()
    {
        ...
        return view('superadmin.academics.teacher-classes.index', compact('teachers', 'classes', 'classTeachers'));
    }
    public function teacherClassStore(Request $request)
    {
        ...
        return redirect(route('superadmin.teacher.class'))->with($notification);
    }
    ...
    public function board()
    {
        ...
        return view('superadmin.board.index', compact('boards'));
    }
    public function boardCreate()
    {
        return view('superadmin.board.add');
    }
    public function boardStore(Request $request)
    {
        ...
        return redirect(route('superadmin.board'))->with($notification);
    }
    public function boardEdit($id)
    {
        $board = AdminBoard::find($id);
        return view('superadmin.board.edit', compact('board'));
    }
    ...
    {
        $subjects = Subject::get();
        return view('superadmin.academics.subject.index', compact('subjects'));
    }
    public function subjectStore(Request $request)
    {
        ...
        return redirect(route('superadmin.subject'))->with($notification);
    }
    ...
    public function subjectGroup()
    {
        ...
        $subjects = Subject::get();
        $subjectGroups = SubjectGroup::get();
        return view('superadmin.academics.subject-group.index', compact('classes', 'sections', 'subjects', 'subjectGroups'));
    }
    public function subjectGroupStore(Request $request)
    {
        ...
        return redirect(route('superadmin.subject.group'))->with($notification);
    }
    ...
    {
        $sections = AdminSection::get();
        return view('superadmin.academics.section.index', compact('sections'));
    }
    public function sectionStore(Request $request)
    {
        ...
        return redirect(route('superadmin.section'))->with($notification);
    }
    ...
    public function classes()
    {
        ...
        //     ->get();
        return view('superadmin.academics.classes.index', compact('classes', 'sections'));
    }
    public function classesStore(Request $request)
    {
        ...
        return redirect(route('superadmin.classes'))->with($notification);
    }
    ...
    public function frontofficeAdmissionEnquiry()
    {
        ...
        return view('superadmin.front-office.admission-enquiry.index', compact('enquiries','sources'));
    }
    public function frontofficeAdmissionEnquiryStore(Request $request)
    {
        ...
        return redirect(route('superadmin.frontoffice.admission.enquiry'))->with($notification);
    }
    ...
    public function frontofficeSettingPurpose()
    {
        ...
        return view('superadmin.front-office.settings.purpose.index', compact('purposes'));
    }
    public function frontofficeSettingPurposeStore(Request $request)
    {
        ...
        return redirect(route('superadmin.frontoffice.setting.purpose'))->with($notification);
    }
    ...
    public function frontofficeSettingComplaint()
    {
        ...
        return view('superadmin.front-office.settings.complaint-type.index', compact('complaints'));
    }
    public function frontofficeSettingComplaintStore(Request $request)
    {
        ...
        return redirect(route('superadmin.frontoffice.setting.complaint'))->with($notification);
    }
    ...
    {
        $sources = AdminSource::get();
        return view('superadmin.front-office.settings.source.index', compact('sources'));
    }
    public function frontofficeSettingSourceStore(Request $request)
    {
        ...
        return redirect(route('superadmin.frontoffice.setting.source'))->with($notification);
    }
    ...
    public function frontofficeVisitorBook()
    {
        ...
        return view('superadmin.front-office.visitor-book.index', compact('visitors', 'allPurposes'));
    }
    public function frontofficeVisitorBookStore(Request $request)
    {
        ...
        return redirect(route('superadmin.frontoffice.visitor.book'))->with($notification);
    }
    ...
    public function frontofficeComplain()
    {
        ...
        return view('superadmin.front-office.complain.index', compact('complains', 'allComplaints', 'allSources'));
    }
    public function frontofficeComplainStore(Request $request)
    {
        ...
        return redirect(route('superadmin.frontoffice.complain'))->with($notification);
    }
    ...
    {
        $classes = AdminClasses::get();
        return view('superadmin.academics.timetable.index', compact('classes'));
    }
    public function timetableView(Request $request)
    {
        ...
        $classes = AdminClasses::get();
        $sections = AdminSection::get();
        return view('superadmin.academics.timetable.view', compact('timeTables', 'classes', 'sections', 'selectedClass', 'selectedSection'));
    }
    public function timetableCreate()
    {
        ...
        $teachers = User::where('role', 'teacher')->get();
        $subjectGroups = SubjectGroup::get();
        return view('superadmin.academics.timetable.add', compact('sections', 'classes', 'teachers', 'subjects', 'subjectGroups'));
    }
    public function timetableStore(Request $request)
    {
        ...
        return redirect(route('superadmin.timetable.add'))->with($notification);
    }
    public function timetableEdit($id)
    {
        ...
        $subjectGroups = SubjectGroup::get();
        $teachers = User::where('role', 'teacher')->get();
        return view('superadmin.academics.timetable.edit', compact('classes', 'timeTable', 'sections', 'teachers', 'subjectGroups'));
    }
    public function timetableUpdate(Request $request, $id)
    {
        ...
        return redirect(route('superadmin.timetable'))->with($notification);
    }
    ...
    public function bank()
    {
        $banks = Bank::get();
        $bankDetails = BankDetails::get();
        return view('superadmin.bank.index', compact('banks', 'bankDetails'));
    }
    public function bankCreate()
    {
        return view('superadmin.bank.add');
    }
    public function bankStore(Request $request)
    {
        ...
        return redirect(route('superadmin.bank'))->with($notification);
    }
    ...
    public function bankDetailCreateName($name)
    {
        ...
        $banks = Bank::get();
        return view('superadmin.bank.add-details', compact('banks', 'selectedBank'));
    }
    ...
    public function bankDetailEdit($id)
    {
        ...
        $banks = Bank::get();
        return view('superadmin.bank.edit-details', compact('detail', 'banks'));
    }
    ...
    public function fund()
    {
        $funds = Fund::get();
        $fund = Fund::latest()->first();
        return view('superadmin.funds.index', compact('funds', 'fund'));
    }
    public function fundCreate()
    {
        return view('superadmin.funds.add');
    }
    public function fundStore(Request $request)
    {
        ...
        return redirect(route('superadmin.fund'))->with($notification);
    }
    ...
    public function expense()
    {
        ...
        $fund = Fund::latest()->first();
        return view('superadmin.expense.index', compact('expenses', 'fund'));
    }
    public function expenseCreate()
    {
        $fund = Fund::latest()->first();
        return view('superadmin.expense.add', compact('fund'));
    }
    public function expenseStore(Request $request)
    {
        ...
        return redirect(route('superadmin.expense'))->with($notification);
    }
    public function expenseReceipt($id)
    {
        ...
        $logo = Logo::first();
        $schoolName = SchoolName::first();
        return view('superadmin.expense.receipt', compact('expense', 'logo', 'schoolName'));
    }
    ...
    public function teacherSalarySearch()
    {
        ...
        return view('superadmin.teacher-salary.index');
    }
    public function teacherSalaryViewTeachers(Request $request)
    {
        ...
        $teachers = TeacherProfile::get();
        $fund = Fund::latest()->first();
        return view('superadmin.teacher-salary.view', compact('date', 'teachers', 'fund'));
    }
    public function teacherSalaryGenerate($id, $date)
    {
        ...
        return view('superadmin.teacher-salary.add', compact('month', 'teacher', 'year', 'teacherSalaryDetails', 'basicSalary', 'basicDaySalary', 'absents', 'lates', 'totalSalary', 'date'));
    }
    public function teacherSalaryStore(Request $request)
    {
        ...
        return redirect(route('superadmin.teacher.salary.search'))->with($notification);
    }
    ...
    public function teacherSalaryPayslip($id)
    {
        ...
        $logo = Logo::first();
        $schoolName = SchoolName::first();
        return view('superadmin.teacher-salary.payslip', compact('salary', 'teacher', 'logo', 'schoolName', 'accountDetails'));
    }
    ...
    public function noticeBoard()
    {
        ...
        return view('superadmin.notice-board.index', compact('notices'));
    }
    public function noticeBoardStore(Request $request)
    {
        ...
        return redirect(route('superadmin.notice.board'))->with($notification);
    }
